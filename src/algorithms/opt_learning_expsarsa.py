...
class OptLearningExpSARSA(OptLearningTD0Base):
...
if __name__ == '__main__':
    ...
    this_qf_dict = es_obj.get_act_value_func_dict(pol_obj)
    print(this_qf_dict)
    this_vf_dict = es_obj.get_value_func_dict(pol_obj)
    print(this_vf_dict)

    opt_pol = es_obj.get_optimal_det_policy()
    print(opt_pol.policy_data)
    opt_vf_dict = es_obj.get_value_func_dict(opt_pol)
    print(opt_vf_dict)
